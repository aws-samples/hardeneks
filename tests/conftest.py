...
def resources(request):
    ...
    resource_loaders = {
        "resource_quotas": lambda: get_response(client.CoreV1Api, os.path.join(data_directory, "resourcequota_api_response.json"), "V1ResourceQuotaList").items,
...
def namespaced_resources(request):
    ...
    # Resource loaders mapping
    resource_loaders = {
        "namespaces": lambda: get_response(client.CoreV1Api, os.path.join(data_directory, "namespace_api_response.json"), "V1NamespaceList").items,
        "pods": lambda: get_response(client.CoreV1Api, os.path.join(data_directory, "pod_api_response.json"), "V1PodList").items,
        "services": lambda: get_response(client.CoreV1Api, os.path.join(data_directory, "service_api_response.json"), "V1ServiceList").items,
        "roles": lambda: get_response(client.RbacAuthorizationV1Api, os.path.join(data_directory, "role_api_response.json"), "V1RoleList").items,
        "cluster_roles": lambda: get_response(client.RbacAuthorizationV1Api, os.path.join(data_directory, "clusterrole_api_response.json"), "V1ClusterRoleList").items,
        "role_bindings": lambda: get_response(client.RbacAuthorizationV1Api, os.path.join(data_directory, "rolebinding_api_response.json"), "V1RoleBindingList").items,
        "cluster_role_bindings": lambda: get_response(client.RbacAuthorizationV1Api, os.path.join(data_directory, "clusterrolebinding_api_response.json"), "V1ClusterRoleBindingList").items,
        "daemon_sets": lambda: get_response(client.AppsV1Api, os.path.join(data_directory, "daemonset_api_response.json"), "V1DaemonSetList").items,
        "stateful_sets": lambda: get_response(client.AppsV1Api, os.path.join(data_directory, "statefulset_api_response.json"), "V1StatefulSetList").items,
        ...
        "hpas": lambda: get_response(client.AutoscalingV1Api, os.path.join(data_directory, "horizontalpodautoscaler_api_response.json"), "V1HorizontalPodAutoscalerList").items,
    }
